...
let resposta = linguagemPreferida;
...
if (idade >= 18) {
    console.log(`A idade forneçida é ${idade}, você é maior de idade!`);
}else {
    console.log(`A idade forneçida é ${idade}, você é menor de idade!`);
} 
*/

/* 8. Crie uma variável "numero" e peça um valor com prompt verifique se é positivo, negativo ou zero. Use if-else para imprimir a respectiva mensagem. 
let numero = parseFloat(prompt('Forneça um número para verificar se é negativo, positivo ou 0: '));

if (numero == 0) {
    alert(`O número fornecido é ${numero}.`);
} else if (numero >= 1) {
    alert(`O número fornecido é ${numero} e ele é positivo.`);
} else {
    alert(`O número fornecido é ${numero} e ele é negativo.`);
}
*/
